...
router.get( '/', async ( req, res ) => {
    ...
    console.log( "HENT ALLE - testimonial" );
...
router.get( '/:id', async ( req, res ) => {
    ...
    console.log( "GET/HENT - testimonial" );
...
router.post( '/admin', upload.single( "image" ), async ( req, res ) => {
    ...
    try {
        ...
        return res.status( 201 ).json( { message: "Ny er oprettet", oprettet: testimonial } );
...
router.delete( '/admin/:id', async ( req, res ) => {
    ...
    try {
        ...
        return res.status( 200 ).json( { message: "Testimonial er slettet" } );
...
router.put( '/admin/:id', upload.single( "image" ), async ( req, res ) => {
    ...
    try {
        ...
        return res.status( 201 ).json( { message: "Testimonial er rettet", rettet: testimonial } )
