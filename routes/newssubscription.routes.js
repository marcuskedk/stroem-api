...
router.get( '/admin/:id', async ( req, res ) => {
    ...
    try {
        ...
        if ( newssubscription == null ) {
            return res.status( 404 ).json( { message: 'Data/Newssubscription kunne ikke findes' } );
        }
...
router.delete( '/admin/:id', async ( req, res ) => {
    ...
    try {
        ...
        return res.status( 200 ).json( { message: "Newssubscription er slettet" } );
...
router.delete( '/afmeld/:email', async ( req, res ) => {
    ...
    try {
        ...
        if ( newssubscription == null ) {
            return res.status( 404 ).json( { message: 'Data kunne ikke findes/slettes - ingen med den email' } );
        }
